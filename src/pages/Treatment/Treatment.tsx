...
};
{
  /* <p>
        ...
        <p>
          אדם פונה לטיפול, בדרך כלל, כאשר המחיר מתחיל להיות לו יקר. כלומר, הוא
          מרגיש מחיר זה במספר תחומים בחייו (מערכות יחסים, קריירה, בריאות....).
          בטיפול, בתור התחלה מתקיימות עצירה והתבוננות על החיים, עצירה זאת נהייתה
          זרה ונדירה בעולם המודרני האינטנסיבי והמהיר אך היא חשובה ואפקטיבית. דרך
          התבוננות, השיתוף, ההקשבה והחשיבה המשותפת מתהוות מודעות עצמית ודרך
          התמודדות מיטיבה יותר.
        </p>
        <p>
          אני מאמין שכל אחד יכול להפיק מטיפול אך רובנו בוחרים להתחיל טיפול כאשר
          המחיר שאנחנו משלמים בחיינו על דרכי ההתמודדות שלנו נאגר ואנחנו מבינים
          באופן עמוק שהגיע הזמן לשינוי כלשהו. תחילת טיפול פסיכולוגי עשויה להיות
          הצעד הראשון בשינוי זה.
        </p> */
}
